...
public class RemoverProduto extends JFrame{
	...
	public RemoverProduto() {
		...
		lblRemoverProduto.setForeground(new Color(53, 152, 220));
		lblRemoverProduto.setFont(new Font("Dialog", Font.PLAIN, 26));
		lblRemoverProduto.setBounds(0, 12, 387, 51);
		getContentPane().add(lblRemoverProduto);
		
		JLabel lblDigiteOId = new JLabel("Digite o ID do Produto que deseja remover");
		...
		spinner.addKeyListener(new KeyAdapter() {
			...
			public void keyPressed(KeyEvent e) {
				if(e.getKeyCode() == KeyEvent.VK_ENTER) {
					try {
						ProdutoController.deletar(Integer.valueOf(spinner.getText()));
					} catch (Exception e2) {
