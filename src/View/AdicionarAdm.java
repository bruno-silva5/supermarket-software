...
public class AdicionarAdm extends JFrame{
	...
	public AdicionarAdm() {
		...
		JLabel lblAdicionarAdm = new JLabel("Adicionar Adm");
		lblAdicionarAdm.setFont(new Font("Arial", Font.PLAIN, 26));
		lblAdicionarAdm.setForeground(new Color(53,152,220));
		lblAdicionarAdm.setHorizontalAlignment(SwingConstants.CENTER);
		lblAdicionarAdm.setBounds(0, 12, 366, 51);
		getContentPane().add(lblAdicionarAdm);
	...
	private void cadastrar() {
		if(!(txtNome.getText().equals("") || txtEmail.getText().equals("") || new String(passwordField.getPassword()).equals(""))) {
			...
			if (AdmController.insert(admModel)) {
				txtEmail.setText("");
				txtNome.setText("");
