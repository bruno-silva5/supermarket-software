...
public class ListarAdmEditar extends JFrame{
	public ListarAdmEditar() {
    ...
    public void criaJanela(){
        ...
        tabela.addMouseListener(new MouseAdapter() {
        	...
        	public void mouseClicked(MouseEvent e) {
        		...
        		admModel.setId(Integer.parseInt(tabela.getValueAt(tabela.getSelectedRow(), 0).toString()));
        		admModel.setNome(tabela.getValueAt(tabela.getSelectedRow(), 1).toString());
        		admModel.setEmail(tabela.getValueAt(tabela.getSelectedRow(), 2).toString());
        		setVisible(false);
        		new AtualizarAdm(admModel);
        	}
		});
